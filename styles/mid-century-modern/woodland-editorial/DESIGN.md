---
name: Woodland Editorial Mid-Century
slug: woodland-editorial
family: mid-century-modern
description: "A quieter domestic interpretation using warm woods, humane serif typography, and furniture-like horizontal joinery instead of atomic graphic energy."
tags:
  - mid-century-modern
  - woodland-editorial
  - complete-system
...
# Woodland Editorial Mid-Century

## Overview and Design Philosophy

A quieter domestic interpretation using warm woods, humane serif typography, and furniture-like horizontal joinery instead of atomic graphic energy.
...
Use a 3:2 opening with a 62px regular serif title. Give the workspace generous interiors and a dark top rail. Feature stories stack in broad reading bands.

The distinction from **Atomic Graphics Mid-Century** is structural: that interpretation follows this direction: Use a centered 72px bold sans title with a broad workspace below. Features occupy unequal two-column blocks. Oversized statistics and small geometric index marks provide rhythm. Choose this variant when the composition above suits the content. A palette substitution alone does not establish either interpretation.

## Visual Character

Use oatmeal, warm brown, soft olive, and restrained wood-like linear texture at section edges. Thin joinery lines replace decorative geometric blocks.
...
- Buttons are modest rounded rectangles with a solid walnut fill. Tabs use understated underlines. Forms and dialogs sit on calm cream surfaces with a warm top edge.
...
| `muted` | `#5b6151` | Secondary text on surface |
...
Use original natural-material or furniture photographs in wide crops. Keep texture subtle and never place body text on wood grain.
...
Use 180ms color changes with no card lift or material movement.
...
- **Active / pressed:** Use 180ms color changes with no card lift or material movement.
...
.design .hero{display:grid;grid-template-columns:3fr 2fr;gap:48px;align-items:start}.design .hero h1{font:400 62px/1.1 Georgia,serif}
.design .project-card{background:#f5eddc;border:1px solid #93836c;border-top:12px solid #715642;border-radius:4px;box-shadow:0 6px 16px #493b2514;padding:32px}
.design .features{grid-template-columns:1fr;gap:36px}.design .feature-card:nth-child(n){background:none;border:0;border-top:2px solid #93836c;border-radius:0;padding:32px 0;box-shadow:none}
.design .feature-card h3{font:400 30px/1.2 Georgia,serif}.design .feature-index{font-family:Georgia,serif;font-style:italic}
.design .stats{border-block:2px solid #93836c;padding:28px 0;background:none}.design .stats strong{font:400 44px/1.1 Georgia,serif}
.design .testimonial{font:italic 26px/1.6 Georgia,serif;border:0;border-left:6px solid #715642;text-align:left;padding:32px}
.design .testimonial blockquote{font:italic 26px/1.6 Georgia,serif}
.design .demo-form{background:#f5eddc;border:1px solid #93836c;border-top:12px solid #715642;border-radius:4px}
