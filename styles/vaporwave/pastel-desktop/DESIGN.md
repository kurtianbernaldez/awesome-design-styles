...
**Pointer policy: surface.** Only the simulated window surface needs a moving reflection.

### Window glint

A narrow pastel window reflection tracks horizontal movement. This is decorative material feedback, not a status indicator.
