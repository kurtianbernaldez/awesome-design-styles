---
name: Community Story Corporate Memphis
slug: community-story
family: corporate-memphis
description: "A narrative interpretation where oversized friendly illustration and generous storytelling sections take priority over compact product explanation cards."
tags:
  - corporate-memphis
  - community-story
  - complete-system
...
# Community Story Corporate Memphis

## Overview and Design Philosophy

A narrative interpretation where oversized friendly illustration and generous storytelling sections take priority over compact product explanation cards.
...
Center a 68px rounded sans title above a broad illustrated workspace. Features form spacious two-column chapters with a full-width opening story.

The distinction from **Service Guide Corporate Memphis** is structural: that interpretation follows this direction: Use a compact 4:5 opening with a 48px bold title. Keep a small illustration strip in the workspace. Feature steps stack with colored number cells and aligned descriptions. Choose this variant when the composition above suits the content. A palette substitution alone does not establish either interpretation.

## Visual Character

Use warm pale backgrounds, organic flat color fields, and broad curved containers. Keep shadows absent; the original human-centered artwork carries warmth.
...
- Actions are large friendly capsules. Tabs are plainly labeled story chapters. Forms use generous fields and dialogs use one calm rounded panel.
...
Use the existing original community illustration prominently in a wide crop. Preserve diverse figures without treating them as interchangeable decoration or implying real testimonials.
...
Use 180ms color changes; illustrated people remain still.
...
- **Active / pressed:** Use 180ms color changes; illustrated people remain still.
...
.design .hero{display:block;padding:48px 0}.design .hero-copy{text-align:center;max-width:780px;margin:auto}.design .hero h1{font:750 68px/1.05 system-ui,sans-serif}
.design .hero-copy p{margin-inline:auto}.design .actions{justify-content:center}.design .project-card{max-width:880px;margin:40px auto 0;border:0;border-radius:48px 16px;background:#efe2ce;box-shadow:none;padding:32px}
.design .style-artwork{height:280px;border-radius:32px 12px;background-position:center}.design .features{grid-template-columns:1fr 1fr;gap:36px}
.design .feature-card:nth-child(n){border:0;border-radius:40px 12px;background:#dce7db;padding:36px}.design .feature-card:first-child{grid-column:1/-1}
.design .stats{border:0;background:#efe2ce;border-radius:32px;padding:32px}.design .stats strong{font-size:44px}
.design .testimonial{border:0;font-size:26px}
.design .testimonial blockquote{font-size:26px}.design .demo-form{border:0;border-radius:40px 12px;background:#dce7db}
