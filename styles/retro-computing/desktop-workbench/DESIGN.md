...
description: "A desktop workbench expressed through window title strips, raised beveled buttons, and recessed work areas."
tags:
  - retro-computing
  - desktop-workbench
  - complete-system
...
Wrap the page in one window-like shell with a 3px outset border and a colored navigation strip. Use a compact 56px monospace headline and a 28px hero gap. The workspace contains its own title strip and inset list.
...
- Use a muted teal desktop around a gray workbench.
- Let the control construction explain state and hierarchy.
- Do not use a modern rounded card layout with a monospace font and call it retro computing.
...
| `muted` | `#435753` | Secondary text on surface |
...
Use a muted teal desktop around a gray workbench. Window regions have 3px outset edges; editable or readout regions have 3px inset edges. Corners are square. Shadow is a small hard separation, not modern elevation.
...
Buttons use neutral gray fill and bevels rather than accent-filled pills. Press reverses the bevel. Selected tabs connect visually to the containing region. Inputs, selects, dialogs, and menus follow the same raised/inset distinction.
...
Use original simple desktop-era functional icons. Do not recreate a recognizable commercial operating system, brand colors, window controls, or proprietary bitmap font.
...
States change immediately. Bevel reversal communicates press without bounce, fade, or blur.
...
- **Active / pressed:** States change immediately. Bevel reversal communicates press without bounce, fade, or blur.
...
Background reference: [Computer History Museum: graphical interface](https://www.computerhistory.org/revolution/input-output/14/347/1859). The rules in this document are an original interface interpretation, not a reproduction of a source artifact or a claim that this variant exhausts the family.
