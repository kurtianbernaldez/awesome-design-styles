...
family: wabi-sabi
description: "Modest, sparse, and gently irregular composition with warm uncoated surfaces and visible breathing room."
tags:
  - wabi-sabi
  - quiet-imperfection
  - complete-system
...
Use a 1.2:1 opening with an 80px gap and a 68px regular serif headline. Place the workspace 64px lower on wide screens. Feature columns are unequal and step down 32px at a time. Let the quiet asymmetry remain visible rather than filling every gap.
...
- Use a warm matte canvas and a muted earth panel with slightly unequal 3–12px corners.
- Let the control construction explain state and hierarchy.
- Do not confuse intentional modesty with unfinished UI, or replace organic asymmetry with a perfectly repeating beige card grid.
...
Use a warm matte canvas and a muted earth panel with slightly unequal 3–12px corners. Remove shadows and most framing. Outside the workspace, content groups begin with a single quiet rule. Texture stays extremely subtle.
...
Controls remain simple and legible. Icon tools may be unboxed but retain full targets and explicit accessible names. Inputs use ordinary boundaries; tabs and dialogs remain composed, modest surfaces.
...
Use original natural material details or imperfect handmade objects where meaningful. Avoid fake cracks, staged dirt, and generalized cultural symbols. Empty space is an intentional visual element.
...
Use immediate states or 160ms color feedback. No ornamental movement or reveal-on-scroll.
...
- **Active / pressed:** Use immediate states or 160ms color feedback. No ornamental movement or reveal-on-scroll.
...
Background reference: [V&A: ceramics and rusticity](https://www.vam.ac.uk/articles/ceramics-a-risky-business). The rules in this document are an original interface interpretation, not a reproduction of a source artifact or a claim that this variant exhausts the family.
