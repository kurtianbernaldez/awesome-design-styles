...
family: art-deco
description: Stepped geometry, symmetrical framing, and restrained metallic accents around a confident hierarchy.
tags:
  - art-deco
  - geometric-elegance
  - complete-system
...
Stepped geometry, symmetrical framing, and restrained metallic accents around a confident hierarchy. This is one original interpretation of the art deco family, not a definitive rulebook for the entire aesthetic. It is intended for complete websites and application surfaces that benefit from this visual character. Its layout, material choices, and control conventions below define why it exists as a separate system.

Use a centered hero statement above a contained project panel and equal two-column features. Align paired elements symmetrically. Follow the centered introduction with left-aligned prose, forms, and pricing benefits. Use stepped border accents only around major sections.
...
Use composed serif display headings and plain sans controls. Short eyebrows may use 0.14em uppercase tracking; body text never does. Keep symmetry in headline grouping without centering long paragraphs.

| Role | Stack | Size / line height | Weight and tracking |
|---|---|---|---|
| Display / H1 | `ui-serif, Georgia, serif` | fluid 36–68px / 1.08 | 500; -0.03em |
| H2 | `ui-serif, Georgia, serif` | 38px / 1.2 | 500; -0.02em |
...
Primary buttons use warm accent with dark labels and a square double-rule surround. Secondary actions use dark surface and a control-line border. Fields are opaque and rectangular. Cards use a quiet double frame; recommended pricing adds a small centered text badge. Navigation uses evenly spaced links and a fine lower rule. Tabs have warm underlines. Menus and dialogs are dark opaque rectangles with a double frame and plain sans-serif task content.
...
Original geometric line illustrations and vertically composed photographs are suitable. Keep decorative fans or repeated steps outside the reading area. Icons are fine 1.5px strokes but large enough to read. Charts stay simple and flat on dark panels, with direct labels and dashed series distinctions; no metallic gradients in data marks.
...
Use 180ms ease-out color changes and a short dialog fade. No glint sweep, animated ornament, or cinematic delays before content. Reduced motion makes transitions immediate.
...
```css
.design-art-deco-geometric-elegance {
  --canvas: #1f292b;
  --surface: #293638;
  --ink: #f3ead5;
  --muted: #cbbf9f;
...
.design-art-deco-geometric-elegance * { box-sizing: border-box; }
```
...
- separate decoration from task content.
- Preserve the readable control and feedback behavior when adapting the visual composition.

## Don't

- Do not use gold for low-contrast paragraphs or copy historic logos and distinctive motifs.
