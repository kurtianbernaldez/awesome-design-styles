...
description: "Flat vector-era energy through bold silhouettes, colorful stripes, oversized circles, and rhythmic sans-serif composition."
tags:
  - frutiger-metro
  - flat-rhythm
  - complete-system
...
Use a 1:1 opening, a 36px gap, and a large lowercase 84px headline. A cropped sequence of concentric pink, teal, and dark circles sits behind the opaque workspace. Repeat the stripe rhythm in feature caps and a dark statistics band.
...
- Keep surfaces completely flat and shadow-free.
- Let the control construction explain state and hierarchy.
- Do not confuse Metro with Aero: avoid glass, glossy gel buttons, sky photography, and diffuse shadows.
...
Keep surfaces completely flat and shadow-free. Panels are solid paper-colored planes; the workspace has a 12px teal leading stripe. Color and silhouette establish the depth hierarchy without gloss or transparency.
...
Controls are flat with clear boundaries. Use regular geometric icon weights, square text buttons, and consistent tabs. Forms sit on plain backgrounds while decorative circles stay behind the content region.
...
Use original vector-like silhouettes and geometric rhythm. This variant emphasizes abstract graphics rather than people or city silhouettes so the shared workspace content remains primary.
...
Use 120ms color changes. No spinning rings or parallax; the graphic rhythm is static.
...
- **Active / pressed:** Use 120ms color changes. No spinning rings or parallax; the graphic rhythm is static.
...
Background reference: [Frutiger Aero archive: Frutiger Metro](https://frutiger-aero.org/frutiger-metro). The rules in this document are an original interface interpretation, not a reproduction of a source artifact or a claim that this variant exhausts the family.
