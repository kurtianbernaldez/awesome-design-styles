---
name: Urban Poster Frutiger Metro
slug: urban-poster
family: frutiger-metro
description: "A street-poster interpretation of flat urban optimism, led by oversized type and layered geometric silhouettes rather than repeated product tiles."
tags:
  - frutiger-metro
  - urban-poster
  - complete-system
...
# Urban Poster Frutiger Metro

## Overview and Design Philosophy

A street-poster interpretation of flat urban optimism, led by oversized type and layered geometric silhouettes rather than repeated product tiles.
...
Use an 88px heavy title over a broad flat opening. Offset the workspace to one side. Feature regions form unequal blocks separated by thick neutral gutters.

The distinction from **Wayfinding Tiles Frutiger Metro** is structural: that interpretation follows this direction: Use a compact 4:5 opening with a 48px title. The workspace is a route-like task list. Features stack as broad destination tiles with a stable index rail. Choose this variant when the composition above suits the content. A palette substitution alone does not establish either interpretation.

## Visual Character

Use crisp flat color, high-contrast silhouettes, circles, and hard cropped planes. No glass, photographic realism, or dimensional shadows.
...
- Buttons are flat colored signs with square corners. Tabs use bold label strips; forms and dialogs remain opaque flat blocks with a clear contrast edge.
...
Use original abstract urban graphics. Keep decoration at section margins and avoid copying recognizable transport identities.
...
Use immediate fill changes; silhouettes remain stationary.
...
- **Active / pressed:** Use immediate fill changes; silhouettes remain stationary.
...
.design .hero{display:block;padding:40px 0;background:linear-gradient(135deg,#e6b33c 0 18%,transparent 18%)}
.design .hero-copy{padding:28px;background:#e9ede4;border-left:16px solid #2e6967}.design .hero h1{font:850 88px/.98 system-ui,sans-serif;letter-spacing:-.06em}
.design .project-card{margin:36px 0 0 28%;background:#e4bc50;border:0;border-radius:0;box-shadow:none}
.design .features{grid-template-columns:2fr 1fr;gap:24px}.design .feature-card:nth-child(n){border:0;border-radius:0;background:#c6ddd5}
.design .feature-card:first-child{grid-row:span 2;background:#e4bc50}.design .feature-index{font-size:20px;font-weight:800}
.design .stats{background:#c6ddd5;padding:28px;border:0}.design .stats strong{font-size:56px}
.design .demo-form{border:0;border-left:16px solid #2e6967;border-radius:0;background:#e9ede4}.design .testimonial{text-align:left;border-left:16px solid #e4bc50;padding:32px}
