---
name: Gallery Living Japandi
slug: gallery-living
family: japandi
description: "A spacious residential-gallery interpretation led by large quiet typography and generous display intervals rather than compact working modules."
tags:
  - japandi
  - gallery-living
  - complete-system
...
# Gallery Living Japandi

## Overview and Design Philosophy

A spacious residential-gallery interpretation led by large quiet typography and generous display intervals rather than compact working modules.
...
Center a 68px regular serif title above a broad low workspace. Features form two roomy gallery bays with a full-width lead entry. Maintain long pauses between sections.

The distinction from **Crafted Workspace Japandi** is structural: that interpretation follows this direction: Use a compact 4:5 opening and a 48px medium sans title. Workspace tasks align in clean rows; features stack with a small index rail. Keep 24px module gaps. Choose this variant when the composition above suits the content. A palette substitution alone does not establish either interpretation.

## Visual Character

Use pale plaster, light oak tones, dark thin rules, and almost square corners. Remove decorative shadows; a few warm structural rails suggest crafted joinery.
...
- Actions are understated dark rectangles. Tabs use fine underlines. Forms and dialogs are pale, spacious panels with one warm edge.
...
| `muted` | `#59645b` | Secondary text on surface |
...
Use original interior or object photographs with generous surrounding space. Avoid treating cultural motifs as interchangeable ornament.
...
Use 180ms color transitions and no floating cards.
...
- **Active / pressed:** Use 180ms color transitions and no floating cards.
...
.design .hero{display:block;padding:64px 0}.design .hero-copy{text-align:center;max-width:780px;margin:auto}.design .hero h1{font:400 68px/1.15 Georgia,serif}
.design .hero-copy p{margin-inline:auto}.design .actions{justify-content:center}.design .project-card{max-width:840px;margin:48px auto 0;border:0;border-top:8px solid #9b8265;border-radius:0;background:#eee9dc;box-shadow:none;padding:40px}
.design .features{grid-template-columns:1fr 1fr;gap:48px}.design .feature-card:nth-child(n){border:0;border-top:1px solid #aaa08d;border-radius:0;background:none;padding:36px 0;box-shadow:none}
.design .feature-card:first-child{grid-column:1/-1}.design .feature-card h3{font:400 30px/1.3 Georgia,serif}
.design .stats{border-block:1px solid #aaa08d;padding:36px 0}.design .stats strong{font:400 44px/1.2 Georgia,serif}
.design .testimonial{font:italic 26px/1.7 Georgia,serif;border:0}
.design .testimonial blockquote{font:italic 26px/1.7 Georgia,serif}.design .demo-form{border:0;border-top:8px solid #9b8265;border-radius:0;background:#eee9dc;padding:40px}
