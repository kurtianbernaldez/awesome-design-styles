...
slug: organic
family: solarpunk
description: Warm daylight surfaces and organic framing that make collaborative, practical work feel welcoming.
tags:
  - solarpunk
  - organic
  - complete-system
...
Warm daylight surfaces and organic framing that make collaborative, practical work feel welcoming. This is one original interpretation of the solarpunk family, not a definitive rulebook for the entire aesthetic. It is intended for complete websites and application surfaces that benefit from this visual character. Its layout, material choices, and control conventions below define why it exists as a separate system.

Use a 3:2 hero and equal three-column feature groups. Center collaboration and useful information rather than decorative scenery. A generous testimonial band separates information from action. Keep forms single-column and visibly practical.
...
- Make collective work practical.
...
| `muted` | `#5a7056` | Secondary text on surface |
...
Use a warm serif display and practical sans controls. Body is 17px with generous line spacing. Human warmth comes from rhythm and phrasing, not decorative botanical lettering.
...
Use light opaque paper-like planes, green edges, and gently asymmetric corners. Secondary fields may be pale sun-yellow. Avoid glass layers and resource-heavy perpetual animation. Organic framing stays outside text and field boundaries.

Reference card boundary: 1px where a frame is used; reference corner radius: 22px. Surface shadow: `0 4px 0 #c8d6bd`. Controls generally use 12px corners unless their component treatment specifies a more precise shape. Content stays at layer 0, navigation at 10 when sticky, menus at 20, backdrop at 40, dialog at 50, and transient feedback at 60. Avoid creating stacking contexts on every card. Overlays must remain above all decorative treatments.

## Components

Primary buttons are deep green with white labels and modest 10px corners; do not make them leaf-shaped. Secondary controls use a visible green-gray outline. Inputs stay opaque and rectangular. Cards use 22px/6px corner pairs and stable content hierarchy. Recommended pricing is labeled in words. Navigation is welcoming plain text with an underline; tabs use a dark green selection. Menus and dialogs use warm opaque surfaces and normal keyboard behavior.
...
Use original imagery of shared spaces, cultivation, or repair without implying unsupported environmental claims. Icons use clear rounded strokes. Charts need honest units, sources, and uncertainty where relevant; avoid decorative leaf areas as quantities. Provide an accessible table and textual summary.
...
Use 160ms ease-out color changes. No animated leaves, drifting clouds, or background video. Reduced motion makes updates immediate. Prefer low-cost static surfaces and local assets.
...
.design-solarpunk-organic * { box-sizing: border-box; }
```
...
- Make collective work practical.
- preserve readable daylight contrast.
- use organic edges sparingly.
- Preserve the readable control and feedback behavior when adapting the visual composition.

## Don't

- Do not turn ecological mood into unsupported claims or replace usable buttons with plant silhouettes.
