...
slug: warm-order
family: japandi
description: "Warm, regular order: quiet modular joinery, natural neutrals, and calm contemporary typography."
tags:
  - japandi
  - warm-order
  - complete-system
...
Use equal hero columns with a 64px gap and a regular-weight 64px sans headline. The workspace has one vertical wood-colored rail. Features form a continuous evenly joined row. Keep the spacing deliberate and regular.
...
- Use matte cream and sand fields with no elevated card shadows.
- Let the control construction explain state and hierarchy.
- Do not reduce Japandi to beige alone, or import Wabi-sabi staggered irregularity into this ordered modular interpretation.
...
| `muted` | `#505b52` | Secondary text on surface |
...
Use matte cream and sand fields with no elevated card shadows. A 8px warm rail grounds the workspace; a single fine line separates adjoining modules. Corners stay square or nearly square.
...
Buttons use compact 2px corners and dark green fill. Forms have clear, quiet boundaries. Tabs use one steady underline. Menus and dialogs repeat the neutral plane and fine structural lines.
...
Use restrained original material photography and natural light if imagery is useful. Avoid repetitive stock foliage or unrelated rustic distress.
...
Use 140–160ms color transitions. Controls remain grounded and still.
...
- **Active / pressed:** Use 140–160ms color transitions. Controls remain grounded and still.
...
Background reference: [Japandi Supply House: philosophy](https://shopjapandi.com/pages/japandi-supply-house-values). The rules in this document are an original interface interpretation, not a reproduction of a source artifact or a claim that this variant exhausts the family.
